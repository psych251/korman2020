...
In Experiment 1 of Korman and Khemlani (2020), they presented half of their participants with a number of different teleological generic statements--i.e., assertions of the form NPplural+VPpurposive, e.g., “cars” + “are for driving”--that varied in whether the noun concerned artifacts (e.g., chairs) or biological parts (e.g., eyes) and whether the verbs, experimental and control, yielded either acceptable generalizations (e.g., chairs are for sitting, eyes are for seeing) or false generalizations (e.g., chairs are for dusting, eyes are for blinking). The other half of participants received those same statements in the form of self-referential generalizations (e.g., chairs, in virtue of being chairs, are for sitting, chairs, in virtue of being chairs, are for dusting). Participants indicated whether they thought the statement was true or false on a 7pt Likert scale ranging from -3 (definitely false) to 3 (definitely true). Their study thus involved a mixed design with Statement Type(Teleological Generic, Self-Referential Generalization) as a between-subjects factor and Verb(Experimental, Control) as a within-subjects factor. I don't anticipate any major challenges in implementing this replication.
